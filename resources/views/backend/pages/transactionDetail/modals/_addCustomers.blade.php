  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <form action="{{route('customer.create')}}" class="form" id="add_customer_form" method="POST">
...
<script type="text/javascript">
  ...
  $('#add_customer_form_btn').on('click', function(e) {
    ...
    success: function(response)
    {
      GetCustomer(response['customer'].id);
      new PNotify({
                  title: 'Success',
                  text: response['success'],
                  type: 'success',
      ...
      $("#edit_billing_address").val(response['customer'].billing_address.street_address+' '+response['customer'].billing_address.country);
      $("#edit_shipping_address").val(response['customer'].shipping_address.street_address+' '+response['customer'].shipping_address.country);
  ...
  $("#edit_customer_id").on("change", function(){
    var customer = $("#edit_customer_id").val();
          ...
          console.log(data);
           ...
           var option = '<option value="">Choose option</option>';
            $.each(data, function(key, value) {
                  if(value.id==customer){
                    option +='<option value="'+value.id+'" selected="selected">'+value.first_name+'</option>';
                  }else {
                    option +='<option value="'+value.id+'">'+value.first_name+'</option>';
                  }
            });
            $('#edit_customer_id').append(option);
  ...
  function GetCustomerById(id){
    $.ajax({
          ...
          success: function(data)
          {
            ...
            $("#edit_billing_address").val(data.billing_address.street_address+' '+data.billing_address.country);
            $("#edit_shipping_address").val(data.shipping_address.street_address+' '+data.shipping_address.country);
            $("#edit_email").val(data.email);
