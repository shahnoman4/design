...
<!-- add customer Modal -->
@include('backend.pages.suppliers._addSuppliers')
...
<script type="text/javascript">
  var dataTableRoute = "{{ route('admin.supplier.fetch') }}";
  var editRoute = "{{route('admin.supplier.edit')}}";
  var disableRoute = "{{route('admin.supplier.delete')}}";
...
$( document ).ready(function() {
  ...
  $('#add_supplier_form_btn').on('click', function(e) {
    e.preventDefault();
    var data = $('#add_supplier_form')[0];
    var formData = new FormData(data);
    $.ajax({
    data: formData,
    type: $('#add_supplier_form').attr('method'),
